...
RTSP_URL = "https://cctvjss.jogjakota.go.id/atcs/ATCS_Lampu_Merah_Pingit3.stream/chunklist_w410777762.m3u8"
...
BEEP_INTERVAL = 2    # Interval beep saat objek diam (dalam detik)
last_beep_time = 0    # Untuk melacak waktu beep terakhir
